...
- refreshed `.github/copilot-instructions.md` to bump the packaged JAR filename to `0.3.1`
...
- refreshed `.github/copilot-instructions.md` to update JAR filename version (0.1.11 → 0.1.12) in the build and run commands

## [0.1.12] - 2026-08-11

### Changed

- refreshed `.github/copilot-instructions.md` to update JAR filename version (0.1.10 → 0.1.11) in the build and run commands

## [0.1.11] - 2026-08-04

### Changed

- refreshed `.github/copilot-instructions.md` to update JAR filename version (0.1.9 → 0.1.10) in the build and run commands

## [0.1.10] - 2026-07-27

### Changed

- refreshed `.github/copilot-instructions.md` to update JAR filename version (0.1.7 → 0.1.9) in the build and run commands
...
- refreshed `.github/copilot-instructions.md` to update JAR filename version (0.1.5 → 0.1.6) in the build and run commands

## [0.1.6] - 2026-06-18

### Changed

- refreshed `.github/copilot-instructions.md` to update JAR filename version (0.1.4 → 0.1.5) in the build and run commands
...
- refreshed `.github/copilot-instructions.md` to fix JAR filename version (1.0.0 → 0.1.0) and correct `Console` method names
